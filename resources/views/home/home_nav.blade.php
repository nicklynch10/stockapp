...
{{--            </div>--}}
            ...
            <li class="NavbarMobile__linkWrap js-nav-level-1">
                <a class="NavbarMobile__link NavbarMobile__link--expandArrow js-nav-level-2-opener" href="/analyze-compare">Analyze & Compare</a>
            </li>
            <li class="NavbarMobile__linkWrap js-nav-level-1">
                <a class="NavbarMobile__link NavbarMobile__link--expandArrow js-nav-level-2-opener" href="/">Pricing</a>
            </li>
