    ...
    <div class="">
        ...
        <div class="flex justify-center mt-6 lg:text-lg overflow-auto">
            <div class="factor-width">
                <form action="{{route('factordetail')}}" method="post">
                    @csrf
                    ...
                    <div class="relative">
                        ...
                        <input type="text" value="{{ $this->ticker }}" name="searchTicker" id="default-search" class="inline p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""  placeholder="Enter Ticker...">
