            ...
            <div class="factor-width">
                <form action="{{route('analyze')}}" method="get">
                    ...
                    <div class="relative">
                        ...
                        <button disabled="" type="button" class="hidden absolute right-2 top-2.5 bottom-2.5 bg-green-600 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" id="spinner_icon" >
