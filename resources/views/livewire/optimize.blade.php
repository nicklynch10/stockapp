            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 example">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="w-full mb-5">
                        ...
                        <h2 class="pt-2 text-2xl">{{ count($toploss) + count($completeIgnore)+ count($ignore) }}</h2>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="w-full shadow-sm h-full rounded shadow overflow-hidden bg-white bg-gray-50 px-1 py-2 self-start flex flex-col justify-between" style="min-width: 100px; ">
                                                <div class="mt-3 my-1">
                                                    ...
                                                    <div class="float-right xs:flex-col xl:flex-col md:flex-col pr-3">
                                                        <a wire:click="confirmCompleteSection( {{ $tl['id'] }} )" class="tooltip cursor-pointer text-green-600 mr-2" title="Add Completed Section"><span class="font-bold"><i class="fa fa-check"></i></span></a>
                                                        {{--                                                    </div>--}}
                                                        {{--                                                    <div class="flex flex-col float-right xs:flex-col xl:flex-col md:flex-col pr-3">--}}
                                                        <a wire:click="confirmIgnoreSection( {{ $tl['id'] }} )" class="tooltip cursor-pointer" title="Add Ignored Section"><span class="font-bold">X</span></a>
                                                    </div>
                                                                ...
                                                                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                                                    ...
                                                                    <li class="py-1 sm:py-4">
                                                                        <div class="flex items-center space-x-4">
                                                                            ...
                                                                            <div class="inline-flex items-center text-sm">
                                                                                <p class="break-all text-green-700">${{ number_format(abs($tl['potentialSavings']),2) }}</p>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                </ul>
...
{{--                                                            @endif--}}
    ...
    @if(isset($completeIgnore) && count($completeIgnore) > 0)
        <div class="mx-auto px-4 py-2 md:py-12">
            <div class="grid grid-cols-12 gap-2">
                <div class="flex flex-col p-8 bg-white sm:rounded-lg px-4 py-4 col-start-1 col-span-12 sm:col-span-12 xs:col-span-12 xs:col-start-2 rounded-lg">
                    <div class="-my-2 sm:-mx-6 lg:-mx-8 example">
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="w-full mb-5 overflow-hidden" style="height: 100%">
                                <div class="grid grid-cols-4 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 lg:grid-cols-4 p-2 overflow-y-auto overflow-x-hidden  w-2/4w-full ">
                                    @foreach($completeIgnore as $key => $tl)
                                        <div class="m-2">
                                            <div class="w-full shadow-sm h-full rounded shadow overflow-hidden bg-white bg-gray-50 px-1 py-2 self-start flex flex-col justify-between" style="min-width: 100px; ">
                                                <div class="mt-3 my-1">
                                                    <div class="flex flex-col float-left xs:flex-col xl:flex-col md:flex-col pl-3">
