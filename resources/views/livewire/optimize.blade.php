                                                    ...
                                                    <div class="mt-3 my-1">
                                                        <div class="flex flex-col items-center xs:flex-col xl:flex-col md:flex-col">
                                                            <div class="flex flex-col justify-between p-4 leading-normal align items-center" style="width: 255px">
                                                                <?php
                                                                    $logoUrl = 'https://ui-avatars.com/api/?name='.$opt->stock_ticker.'&color=7F9CF5&background=EBF4FF';
                                                                ?>
                                                                ...
                                                                <h5 class="mx-2 mb-2 text-center text-2xl break-all font-bold tracking-tight text-gray-900 dark:text-white">
                                                                    <a class=" cursor-pointer whitespace-normal" >{{ $opt->stock_ticker }}</a>
                                                                </h5>
                                                                <p class="mb-1 break-words break-all text-sm text-center font-sans font-light text-grey-dark italic sm:text-xs">{{ $opt->company_name }}</p>
                                                                <p class="mb-1 break-words break-all text-center text-sm font-sans font-light text-grey-dark">{{ \Carbon\Carbon::createFromTimestamp(strtotime($opt->date_of_purchase))->format('F jS, Y') }}</p>
                                                                <p class="mb-1 break-words break-all text-center text-sm font-sans font-light text-grey-dark">{{ $opt->total_long_term_gains }}</p>
                                                                <p class="mb-1 break-words break-all text-center text-sm font-sans font-light text-grey-dark">Account : {{ $opt->account_name }}	</p>
                                                            </div>
