            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 example">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="w-full mb-5">
                        ...
                        <h2 class="pt-2 text-2xl">{{ count($toploss) + count($completeIgnore) }}</h2>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="w-full shadow-sm h-full rounded shadow overflow-hidden bg-white bg-gray-50 px-1 py-2 self-start flex flex-col justify-between" style="min-width: 100px; ">
                                                <div class="mt-3 my-1">
                                                    ...
                                                    <div class="flex flex-col float-right xs:flex-col xl:flex-col md:flex-col pr-3">
                                                        <a wire:click="addignoresection( {{ $tl['id'] }} )" class="tooltip cursor-pointer" title="Add Completed / Ignored Section"><span class="font-bold">X</span></a>
                                                    </div>
                ...
                <div class="-my-2 sm:-mx-6 lg:-mx-8 example">
                    <div class="py-2 border-b-2 border-gray-300 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="inline-flex items-center space-x-2 float-left">
                            <p class="text-xl font-bold">Completed / Ignored</p>
                        </div>
                    </div>
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="w-full mb-5 overflow-hidden" style="height: 100%">
