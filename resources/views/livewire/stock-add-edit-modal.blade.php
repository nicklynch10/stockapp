            ...
            <div class="row setup-content {{ $currentStep != 1 ? 'displayNone' : '' }}" id="step-1">
                <div class="col-xs-12 pt-6">
                    <div class="col-md-12">
                        ...
                        <div class="mb-4">
                            <label for="average_cost" class="block text-gray-700 text-sm font-bold mb-2"><b>Average Purchase Price (per Share) :{{ $this->avepricereadonly }}</b></label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" min="1" oninput="this.value = Math.abs(this.value)" id="share_number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter shares..." wire:model="share_number">
