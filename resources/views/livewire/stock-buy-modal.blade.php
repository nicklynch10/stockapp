    ...
    <x-slot name="content">
        ...
        <div class="col-span-6 lg:col-span-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" min="{{date('Y-m-d')}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" wire:model="date_of_purchase">
