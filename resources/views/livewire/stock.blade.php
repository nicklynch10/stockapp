    ...
    <x-jet-dialog-modal wire:model="isCompanyOpen">
        ...
        <x-slot name="content">
            ...
            <div class="col-span-6 lg:col-span-4">
                ...
                @if($this->issuetype)
                    <div class="mb-4">
                        <label for="stockticker" class="block text-gray-700 font-bold mb-2"><b>Issue Type:</b></label>
        ...
        <x-slot name="content">
            ...
            <div class="col-span-6 lg:col-span-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}">
                    @error('date_of_purchase') <span class="text-red-500">{{ $message }}</span>@enderror
                </div>
            </div>
        </x-slot>
