                                    ...
                                    @if($stock->share_number!=0)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-gray-900">
                                                <x-jet-button wire:click="sell({{ $stock->id }})" class="py-2 px-4">{{__('Stock Sale')}}</x-jet-button>
                                                <x-jet-button wire:click="buy({{ $stock->id }})" class="py-2 px-4">{{__('Stock Buy')}}</x-jet-button>
                                                <x-jet-button wire:click="edit({{ $stock->id }})" class="py-2 px-4">{{__('Edit')}}</x-jet-button>
                                            </td>
                                        </tr>
                                    @endif
                                @empty
