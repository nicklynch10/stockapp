                    ...
                    <x-jet-dropdown align="right" width="60">
                        <x-slot name="trigger">
                            <span class="inline-flex rounded-md">
                                <button type="button" class="inline-flex items-center px-1 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:bg-gray-50 hover:text-gray-700
                                    focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150 inline-flex items-center px-1 border border-transparent">
                                        {{ appName() }}
                        ...
                        <x-slot name="content">
                            <div class="w-60">
                                ...
                                <x-jet-dropdown-link href="{{ route('user.manage-invites') }}">
                                    {{ __('User Invitations') }}
                                </x-jet-dropdown-link>
                            </div>
                        </x-slot>
